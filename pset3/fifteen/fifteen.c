...
void draw(void);
bool move(int tile);
bool lsearch (int key, bool b, ...); //function takes two optional arguments for use inside move()
bool won(void);
